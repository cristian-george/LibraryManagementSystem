...
namespace Library.ServiceLayer.Tests.MockTesting
{
    ...
    public class LibrarianServiceTests
    {
        ...
        /// </summary>
        private Mock<IUserService> librarianServiceMock;

        /// <summary>
        /// The librarian service.
        /// </summary>
        private IUserService librarianService;
        ...
        {
            this.librarianServiceMock = new Mock<IUserService>();
        }
        ...
        public void TestInsert()
        {
            var librarian = new User()
            {
                ...
                UserType = DomainLayer.Enums.EUserType.LibrarianReader,
            };
